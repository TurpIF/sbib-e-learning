...
\subsection{Algorithmes de recommendations contextuelles}
...
L'approche la plus courante retenue dans la personalisation de systèmes d'e-learning est la recommandation de ressources d'apprentissage \cite{DBLP:journals/tlt/VerbertMOWDBD12}. La nature de ces ressource varie en fonction du contexte dans lequel les différentes solutions sont mises en place. 
\subsection{Recommandation de personnes de référence}
Le postulat que l'aide apportée par des collègues est la meilleure stratégie d'apprentisage sur le lieu de travail a motivé le développement de solutions recommandant à l'utilisateur des collaborateurs experts dans des domaines pour lesquels il manque de connaissances.\cite{DBLP:journals/procedia/BehamKLL10} 
